...
export const ru: Content = {
    ...
    health: {
      ...
      doing: [
        ...
        },
        {
          ...
          body:
            'Тумблер, застрявший ниже 40% на месяцы, — это редко проблема знаний. Это проблема системы. Разобрать систему — ровно то, для чего мой бесплатный первый созвон.',
          href: '/ru/#coaching',
  ...
  check: {
    ...
    verdicts: { emergency: 'SOS', pain: 'Болевая точка', growth: 'Зона роста', ok: 'Норм', excellent: 'Отлично' },
    loudestPrefix: 'Самый громкий тумблер сейчас:',
    balanced: 'Все четыре выше 95%. Либо ты привираешь, либо это мне пора к тебе на консультацию.',
  ...
  dialCheck: {
    ...
    intro: 'Двигай каждый ползунок. Ниже 20% — SOS, 20–40 — болевая точка, 40–60 — зона роста, 60–80 — норм, 80+ — отлично. Оценки остаются в твоём браузере.',
  ...
  coaching: {
    ...
    points: [
      ...
      'В основе — четыре тумблера: любовь, здоровье, работа, деньги. Достаточно простые, чтобы вспомнить о них в плохой день. В этом и смысл.',
    ...
    why: [
      ...
      'Четыре тумблера — выжимка из многолетней работы над фреймворками счастья в Happyverse: компании, которую я основал, с pre-seed от Village Global и Джеффа Дина.',
    ...
    faq: [
      ...
      },
      {
        ...
        a: 'Потому что я годами строил фреймворки счастья в AI-компании — и заметил, что ежедневную жизнь переживает только простая версия: любовь, здоровье, работа, деньги. Коучинг — место, где эти четыре тумблера встречаются с настоящей жизнью. С моей в том числе.',
      },
    ],
  },
