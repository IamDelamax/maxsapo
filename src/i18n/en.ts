...
export const en = {
  ...
  check: {
    ...
    verdicts: { emergency: 'Emergency', pain: 'Pain point', growth: 'Growth area', ok: 'OK', excellent: 'Excellent' },
    loudestPrefix: 'Loudest dial right now:',
    balanced: 'All four above 95%. Either you are lying, or I should be booking a call with you.',
  ...
  dialCheck: {
    ...
    intro: 'Slide each dial. Under 20% is an emergency, 20–40 a pain point, 40–60 a growth area, 60–80 OK, 80+ excellent. Scores stay in your browser.',
